...
在智能语音领域，GAN 的应用非常广泛，在语音合成、语音降噪等生成式任务中是一类重要的方法。先在本文介绍下 GAN 的基础知识，包括 GAN 模型的基本思想、数学分析、优化方法及训练目标等，后续会针对语音合成的声码器等具体任务介绍研究者提出的各种模型。本系列主要涉及下面的三篇论文，本文介绍第一篇`GAN 的提出`。
